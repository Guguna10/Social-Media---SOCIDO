...
const RightSide = () => {
    ...
    const handleChangeMedia = (e) => {
        ...
        files.forEach(file => {
            ...
            if(file.size > 1024 * 1024 * 5){
                return err = "The image/video large is 5mb"
            }
    ...
    const handleDeleteConverastion = () => {
        ...
        <>
             <div className="message_header" style={{cursor: 'pointer'}} >
                {
                    ...
                    <UserCard user={user}>
                        <div>
                            ...
                            onClick={handleDeleteConverastion} />
                        </div>
                    </UserCard>
                }
            </div>
            ...
            style={{height: media.length > 0 ? "calc(100% - 180px)" : ""}}>
                <div className="chat_display" ref={refDisplay}>
                    <button style={{marginTop: "-23px", opacity: "0"}} ref={pageEnd}>
                        Load more
                    </button>
                    {
                        data.map((msg, index) => (
            ...
            <form className="chat_input" onSubmit={handleSubmit}>
                ...
                <div className="file_upload">
                    <i className="fas fa-image text-danger" style={{fontSize: "19px"}}/>
